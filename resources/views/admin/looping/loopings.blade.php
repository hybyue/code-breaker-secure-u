...
<div class="container mt-3 pass-slip">
    <div class="row p-2">
        ...
        <div class="col-md-6 text-end">
            ...
            <a href="javascript:void(0)" class="btn text-white" style="background-color: #0B9B19;" aria-hidden="true"  onclick="showPdfModalLooping()">Looping Report</a>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="mx-1">
                                <a href="#" class="btn btn-sm text-white" style="background-color: #1e1f1e" data-bs-toggle="modal" data-bs-target="#viewLooping-{{ $item->id }}"><i class="bi bi-eye"></i></a>
                                </div>
                            <div class="mx-1">
        ...
        <div class="modal-dialog w-100 mt-5 pt-4" style="max-width: 95%;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="viewLoopingLabel-{{ $looping->id }}">Looping Information</h5>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="javascript:void(0)" class="btn btn-sm text-white" style="background-color: #063292" data-id="{{$entry->id}}" data-bs-toggle="modal" data-bs-target="#updateLoopingAdmin-{{ $entry->id }}" onclick="$('#viewLooping-{{ $item->id }}').modal('hide')"><i class="bi bi-pencil-square"></i></a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
...
<!-- Modal Structure -->
<div class="modal fade" id="pdfModalLooping" aria-hidden="false" aria-modal="true" aria-labelledby="pdfModalLabel">
