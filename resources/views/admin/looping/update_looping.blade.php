    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updateLoopingModalLabel-{{ $record->id }}">Edit Looping Record</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form class="updateLoopingFormAdmin" id="updateLoopingFormAdmin-{{ $record->id }}" action="{{ route('update.looping_admin', $record->id)}}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
