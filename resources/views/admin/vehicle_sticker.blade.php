...
<div class="container-fluid mt-2">
    ...
    <div class="container mt-4">
        <form action="/filter_vehicle_admin" method="GET">
            <div class="row pb-3">
                <div class="col-md-3">
                ...
                <div class="col-md-0 mt-4 pt-2">
                    <a href="/filter_vehicle_admin" class="btn btn-secondary">Clear Filter</a>
                </div>
                @endif
            </div>
        </form>
    ...
    <div class="container-fluid p-3 bg-body-secondary rounded">
        ...
        <div class="row">
            <div class="col-12">
                <table id="parkingTable" class="same-height-table table table-hover table-striped table-bordered">
                    <thead>
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="mx-1">
                                        <a href="#" class="btn text-white" style="background-color: #1e1f1e" data-toggle="modal" data-target="#detailsModal-{{ $parking->id }}"><i class="bi bi-eye"></i></a>                                    </div>
                                    <div class="mx-1">
                                        <a href="#" class="btn text-white" style="background-color: #063292" data-bs-toggle="modal" data-bs-target="#updateParking-{{ $parking->id }}"><i class="bi bi-pencil-square"></i></a>
                                    </div>
                                    <div class="mx-1 mt-3">
                                        <form action="{{ route('archive.vehicle', $parking->id) }}" method="POST" type="button" onsubmit="return confirm('Are you sure you want to Archive?')">
                                            @csrf
                                            @method('DELETE')
                                            <button class="btn text-white" style="background-color: #920606"><i class="bi bi-archive-fill"></i></button>
                                        </form>
                                    </div>
                                </div>
                            </td>
...
<div class="modal fade" id="addParking" tabindex="-1" role="dialog" aria-labelledby="addParkingModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('store_parking') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
...
<div class="modal fade" id="updateParking-{{ $parking->id }}" tabindex="-1" aria-labelledby="updateParkingModalLabel-{{ $parking->id }}" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('update.vehicle_sticker_admin', $parking->id)}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-4 form-group">
