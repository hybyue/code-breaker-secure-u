            ...
            <div class="col-12">
                <table id="parkingTable" class="same-height-table table table-hover table-striped table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr id="tr_{{$parking->id}}" class="text-center">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center">
                                    <div class="mx-1">
                                        <a href="#" class="btn btn-sm text-white" style="background-color: #1e1f1e" data-toggle="modal" data-target="#detailsModal-{{ $parking->id }}"><i class="bi bi-eye"></i></a>
                                    </div>
                                    <div class="mx-1">
                                    ...
                                    <div class="mx-1">
                                        <a href="javascript:void(0)" onclick="deleteSticker({{$parking->id}})" class="btn btn-sm text-white" style="background-color: #920606">
...
@include('admin.vehicle_sticker.add_sticker')
@include('admin.vehicle_sticker.update_sticker')
@include('admin.vehicle_sticker.vehicle_js')
